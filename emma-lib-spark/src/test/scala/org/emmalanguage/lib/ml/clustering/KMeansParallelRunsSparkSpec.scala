...
class KMeansParallelRunsSparkSpec extends KMeansParallelRunsSpec with SparkAware {

  override val runs = 2
  override val iterations = 2
  override val overlap = .30

  override def run(k: Int, input: String): Set[kMeansParallelRuns.Solution[Long]] =
